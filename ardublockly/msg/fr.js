...
Ardublockly.LOCALISED_TEXT = {
  ...
  tutoTutoEnded: "Bravo, tu as terminé ce tutoriel !",
  tutoTutoEndedNextOne: "Autre tutoriel",
  tutoStepEnded: "Bravo, vous avez terminé cette étape !",
  tutoStepHardwareTest: "Teste ton programme :",
  tutoStepEndedNextOne: "Etape suivante",                
  tutoIntroStepSidebar: "Suis les instructions affichées dans ce volet",
  tutoIntroStepToolbox: "Prends les blocs dont tu as besoin dans la boîte à outils",
  tutoIntroStepWorkspace: "Agence tes blocs dans l'espace de travail",
  tutoIntroStepAnalysis: "Obtiens une analyse de ton travail en cliquant sur ce bouton",
  tutoIntroStepCompile: "Transfère et teste ton programme sur ta carte Kniwwelino",
