...
Ardublockly.LOCALISED_TEXT = {
  ...
  advanced: " erweitert",
  /* Tutorial */
  tutorialBrowserSupportErrorTitle: "Ihr Browser wird nicht unterstützt!",
  tutorialBrowserSupportError: "Ihr Browser scheint zu alt zu sein. Aktualisieren Sie ihn oder versuchen Sie es mit einem anderen",
  tutorialMenuTitle: "Wählen Sie ein Tutorial",
  tutorialMenuListLoading: "Liste wird geladen …",
  tutorialError: "unerwarteter Fehler",
  tutorialDataAccessError: "Zugriff auf Lernprogrammdaten nicht möglich",
  tutorialNotEnoughDataError: "Nicht genug Daten",
  tutorialExpandBt: "Tutorial",
  tutoStepTitle: "Schritt: ",
  tutoValidateBtTitle: "Bestätigen",
  tutoGoodAnswer: "GUTE ANTWORD",
  tutoAnalyseResultTitle: "Analyseergebnis: ",
  tutoAnalyseResultIncomplete: "unvollständig",
  tutoAnalyseResultSolutionNbOfBlocks: "Die richtige Antwort erfordert %s Blöcke",
  tutoAnalyseResultSolutionNbOfBlocks1: "Die richtige Antwort erfordert %s Block",
  tutoAnalyseResultResponseIntro: "Ihre Antwort besteht aus:",
  tutoAnalyseResultResponseNbOfCorrect: "- %s richtige Blöcke",
  tutoAnalyseResultResponseNbOfCorrect1: "- %s richtig Block",
  tutoAnalyseResultResponseNbOfPartial: "- %s teilweise richtige Blöcke",
  tutoAnalyseResultResponseNbOfPartial1: "- %s teilweise richtig Block",
  tutoAnalyseResultResponseNbOfExtra: "- %s zusätzliche Blöcke",
  tutoAnalyseResultResponseNbOfExtra1: "- %s zusätzlicher Block", 
  tutoAnalyseResultStillExtraBlocks1: "...aber %s Block ist extra",
  tutoAnalyseResultStillExtraBlocks: "...aber %s Blöcke sind extra",
  tutoTutoEnded: "gut gemacht, Sie haben dieses Tutorial beendet!",
  tutoTutoEndedNextOne: "Sie können einen anderen auswählen, indem Sie hier klicken:",
  tutoStepEnded: "gut gemacht, Sie haben diesen Schritt abgeschlossen!",
  tutoStepHardwareTest: "Sie können Ihr Programm auf Kniwwelino testen, indem Sie hier klicken:",
  tutoStepEndedNextOne: "Sie können zum nächsten wechseln, indem Sie hier klicken:",
  tutoIntroStepSidebar: "Befolgen Sie die Anweisungen in diesem Bereich",
  tutoIntroStepToolbox: "Abholung der benötigten Blöcke in der Toolbox",
  tutoIntroStepWorkspace: "Organisieren Sie Ihre Blöcke im Arbeitsbereich",
  tutoIntroStepAnalysis: "Holen Sie sich mit dieser Schaltfläche eine Analyse Ihrer Arbeit",
  tutoIntroTooltipDone: "Fertig",
  tutoIntroTooltipNext: "Weiter",
  tutoIntroTooltipBack: "Zurück",
  tutoIntroTooltipSkip: "Überspringen",
  /* Settings */
