...
Ardublockly.LOCALISED_TEXT = {
  ...
  tutorialDataAccessError: "cannot access tutorial data",
  tutorialNotEnoughDataError: "Not enough data",
  tutorialExpandBt: "Tutorial",
  tutoStepTitle: "Step: ",
  tutoValidateBtTitle: "Validate",
  tutoGoodAnswer: "GOOD ANSWER",
  tutoAnalyseResultTitle: "Analyse result: ",
  tutoAnalyseResultIncomplete: "incomplete",
  tutoAnalyseResultSolutionNbOfBlocks: "The correct answer requires %s blocks",
  tutoAnalyseResultSolutionNbOfBlocks1: "The correct answer requires %s block",
  tutoAnalyseResultResponseIntro: "Your answer is composed of:",
  tutoAnalyseResultResponseNbOfCorrect: "- %s correct blocks",
  tutoAnalyseResultResponseNbOfCorrect1: "- %s correct block",
  tutoAnalyseResultResponseNbOfPartial: "- %s partially correct blocks",
  tutoAnalyseResultResponseNbOfPartial1: "- %s partially correct block",
  tutoAnalyseResultResponseNbOfExtra: "- %s extra blocks",
  tutoAnalyseResultResponseNbOfExtra1: "- %s extra block",
  tutoAnalyseResultStillExtraBlocks1: "...but %s block is in excess",
  tutoAnalyseResultStillExtraBlocks: "...but %s blocks are in excess",
  tutoTutoEnded: "Congratulation, you have finished this tutorial!",
  tutoStepHardwareTest: "You can test your program on Kniwwelino by clicking here:",
  tutoTutoEndedNextOne: "You can choose another one by clicking here:",
  tutoStepEnded: "Congratulation, you have completed this step!",
  tutoStepEndedNextOne: "You can go to the next one by clicking here:",
  tutoIntroStepSidebar: "Follow the instruction specified in this panel",
  tutoIntroStepToolbox: "Pick-up blocks that you need in the toolbox",
  tutoIntroStepWorkspace: "Arrange your blocks in the workspace",
  tutoIntroStepAnalysis: "Get an analysis of your work with this button",
  tutoIntroTooltipDone: "Done",
  tutoIntroTooltipNext: "Next",
  tutoIntroTooltipBack: "Back",
  tutoIntroTooltipSkip: "Skip",
  /* Settings */
