...
Blockly.Msg.AUTH = "Veuillez autoriser cette application à permettre la sauvegarde de votre travail et à l’autoriser à être partagé par vous.";
...
Blockly.Msg.CONTROLS_FOR_TITLE = "compte avec %1 de %2 à %3 par %4";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "répéte %1 fois";
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Exécuter des instructions plusieurs fois.";
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL = "https://github.com/google/blockly/wiki/Loops#repeat";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "répéte jusqu’à";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "répéte tant que";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP = "Créer une copie de la partie spécifiée d’une liste.";
...
Blockly.Msg.MATH_CHANGE_TITLE = "augmente %1 de %2";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "contrains %1 entre %2 et %3";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "Renvoie à la puissance d’un nombre.";
...
Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH = "crée un texte avec";
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Crée un morceau de texte en agrégeant un nombre quelconque d’éléments.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_INPUT_DO = Blockly.Msg.CONTROLS_IF_MSG_ELSE;
...
Blockly.Msg.ARD_ANALOGWRITE = "fixe le port";
Blockly.Msg.ARD_ANALOGWRITE_TO = "sur la valeur analogique";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Ecrit une valeur analogique comprise entre 0 et 255 sur le port PWM spécifique";
Blockly.Msg.ARD_BUILTIN_LED = "Configurer la LED";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Allumer ou éteindre la LED de la carte";
...
Blockly.Msg.ARD_DIGITALWRITE = "fixe le port";
Blockly.Msg.ARD_DIGITALWRITE_TO = "sur la valeur digitale";
...
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Arrêt de la génération de tonalité (son)sur un signal";
Blockly.Msg.ARD_NOTONE_TIP = "Eteindre / Activer la tonalité du signal selectionné";
Blockly.Msg.ARD_PIN_WARN1 = "Signal %1 est utilisé pour %2 alors que signal %3. Déjà utilisé en tant que %4.";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Mesure la durée d'une pulsation sur le port selectionné, dans le delai imparti";
Blockly.Msg.ARD_PULSE_READ = "mesure la pulsation %1 sur le port %2";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "mesure la pulsation %1 sur le port %2 (délai de retard %3 μs)";
Blockly.Msg.ARD_PULSE_TIP = "Mesure la durée d'une pulsation sur le port selectionné.";
...
Blockly.Msg.ARD_SERVO_WRITE = "fixe l'angle du servomoteur du port";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "degrés (0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Configurer un servomoteur à un angle donné";
Blockly.Msg.ARD_SERVO_WRITE_TO = "sur";
...
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "Envoie d'un message SPI à un esclave précis et récuperation de la donnée.";
...
Blockly.Msg.ARD_TYPE_CHAR = "Type";
...
Blockly.Msg.ARD_TYPE_NULL = "Null (vide)";
...
Blockly.Msg.KNIWWELINO_GETIP_TIP = "Retourne l'adresse IP du périphérique"
Blockly.Msg.KNIWWELINO_GETMAC = 'Adresse WIFI MAC'
Blockly.Msg.KNIWWELINO_GETMAC_TIP = "Retourne l'adresse MAC WIFI du périphérique"
Blockly.Msg.KNIWWELINO_GETSSID = 'WIFI SSID'
Blockly.Msg.KNIWWELINO_GETSSID_TIP = "Retourne le SSID WIFI auquel ton Kniwwelino est connecté"
...
Blockly.Msg.KNIWWELINO_HUE_SELECTCOLOR_TIP = "Définir la teinte d'une couleur. [0-255]"
...
Blockly.Msg.KNIWWELINO_RGB_SETCOLOREFFECT = 'fixe la couleur de la LED RVB sur'
Blockly.Msg.KNIWWELINO_RGB_SETCOLOREFFECT_TIP = 'Configure la LED RVB sur couleur et effet'
Blockly.Msg.KNIWWELINO_RGB_SETEFFECT = "fixe l'effet de la LED RVB sur"
...
Blockly.Msg.KNIWWELINO_MATRIX_DRAWICONCREATOR_TIP = 'Dessine une icône';
Blockly.Msg.KNIWWELINO_MATRIX_DRAWICONCHOOSER = "affiche l'icône sur la matrice";
...
Blockly.Msg.KNIWWELINO_MATRIX_DRAWPIXEL = 'active un pixel sur la matrice';
...
Blockly.Msg.KNIWWELINO_MATRIX_SHOWPIXELS = 'active les nombre des pixels sur la matrice';
Blockly.Msg.KNIWWELINO_MATRIX_SHOWPIXELS_TIP = 'Active les nombre des pixels sur la matrice';
Blockly.Msg.KNIWWELINO_MATRIX_SHOWPIXELS_WARNING = 'La valeur doit être compris entre 0-25.';
...
Blockly.Msg.KNIWWELINO_MATRIX_BLINKRATE = 'fixe la fréquence du clignotement de la matrice sur';
...
Blockly.Msg.KNIWWELINO_BUTTON_CLICKED = "a été cliqué";
Blockly.Msg.KNIWWELINO_BUTTON_CLICKED_TIP = "Retourne si le bouton a été cliqué";
...
// SENSORS
Blockly.Msg.KNIWWELINO_SENSOR_READ = " mesure la "
Blockly.Msg.KNIWWELINO_SENSOR_TIP = "Utilise le capteur pour mesurer le paramètre sélectionné";
Blockly.Msg.KNIWWELINO_SENSOR_DISTANCE = "distance"
Blockly.Msg.KNIWWELINO_SENSOR_CM = " [cm]"
Blockly.Msg.KNIWWELINO_SENSOR_TRIGGER = "Emetteur :"
Blockly.Msg.KNIWWELINO_SENSOR_ECHO = "Récepteur :"
Blockly.Msg.KNIWWELINO_SENSOR_LIGHTLEVEL = "luminosité en lux "
Blockly.Msg.KNIWWELINO_SENSOR_TEMP = "température"
Blockly.Msg.KNIWWELINO_SENSOR_HUM = "humidité"
Blockly.Msg.KNIWWELINO_SENSOR_PRESSURE = "pression"
Blockly.Msg.KNIWWELINO_SENSOR_HEIGHT = "hauteur"
Blockly.Msg.KNIWWELINO_SENSOR_TEMP = "température"
Blockly.Msg.KNIWWELINO_SENSOR_GAS = "gaz"
Blockly.Msg.KNIWWELINO_SENSOR_PROXIMITY = "proximité"
Blockly.Msg.KNIWWELINO_SENSOR_GESTURE = "geste"
Blockly.Msg.KNIWWELINO_SENSOR_WHITE = "composante blanche"
...
Blockly.Msg.KNIWWELINO_WEATHER_WEATHERTOPICCHOOSER_TIP = "Choisir un sujet météo auquel vous voudriez vous abonner."
Blockly.Msg.KNIWWELINO_WEATHER_WEATHERCONSTCHOOSER_TIP = "Choisir une condition météorologique à comparer."
...
Blockly.Msg.KNIWWELINO_WEATHER_HUMIDITY = "humidité [rel%]"
Blockly.Msg.KNIWWELINO_WEATHER_PRESSURE = "pression [mBar]"
Blockly.Msg.KNIWWELINO_WEATHER_WINDSPEED = "vitesse du vent [m/s]"
...
Blockly.Msg.KNIWWELINO_WEATHER_COND_ATMOSPHERE = "atmosphère"
Blockly.Msg.KNIWWELINO_WEATHER_COND_MIST = "brume"
Blockly.Msg.KNIWWELINO_WEATHER_COND_FOG = "brouillard"
Blockly.Msg.KNIWWELINO_WEATHER_COND_CLEAR = "clair"
Blockly.Msg.KNIWWELINO_WEATHER_COND_CLOUDS = "nuages"

// AUDIO
Blockly.Msg.KNIWWELINO_AUDIO_PLAY_NOTE = "joue la note"
Blockly.Msg.KNIWWELINO_AUDIO_PLAY_TONE = "joue la tonalité"
Blockly.Msg.KNIWWELINO_AUDIO_NOTE_DURATION = "d'une durée de 1/"
Blockly.Msg.KNIWWELINO_AUDIO_PIN = "sur le port"
Blockly.Msg.KNIWWELINO_AUDIO_TONEOFF = "arrête le son sur le port"
...
Blockly.Msg.KNIWWELINO_NOTE_C = "Do"
Blockly.Msg.KNIWWELINO_NOTE_CS = "Do#"
Blockly.Msg.KNIWWELINO_NOTE_D = "Re"
Blockly.Msg.KNIWWELINO_NOTE_DS = "Re#"
Blockly.Msg.KNIWWELINO_NOTE_E = "Mi"
Blockly.Msg.KNIWWELINO_NOTE_F = "Fa"
Blockly.Msg.KNIWWELINO_NOTE_FS = "Fa#"
Blockly.Msg.KNIWWELINO_NOTE_G = "Sol"
Blockly.Msg.KNIWWELINO_NOTE_GS = "Sol#"
Blockly.Msg.KNIWWELINO_NOTE_A = "La"
Blockly.Msg.KNIWWELINO_NOTE_AS = "La#"
Blockly.Msg.KNIWWELINO_NOTE_B = "Si"

// DATE TIME
Blockly.Msg.KNIWWELINO_GET_TIME = "transforme la date/heure actuelle sous la forme :"
Blockly.Msg.KNIWWELINO_GET_TIMEINT = "transforme la date/heure actuelle en chiffre :"
...
Blockly.Msg.KNIWWELINO_TIME_SINCE1970 = "millisecondes depuis 1.1.1970"
...
Blockly.Msg.KNIWWELINO_RGB_NEOPIXEL_STOP = "Stop l'effet sur la bande";
Blockly.Msg.KNIWWELINO_RGB_NEOPIXEL_STOP_TIP = "Stop l'effet sur la bande";
